...
public class AutoserviceConfig {
    ...
    public boolean isAddRemoveFreeCarPlacesPermission() {
        return addRemoveFreeCarPlacesPermission;
    }

    public boolean isShiftOrderTimePermission() {
        return shiftOrderTimePermission;
    }

    public boolean isRemoveOrderPermission() {
        return removeOrderPermission;
    }
}