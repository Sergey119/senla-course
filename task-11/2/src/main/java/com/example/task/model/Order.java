...
public class Order {
    ...
    public Order(ServiceAdvisor serviceAdvisor, List<Technician> technicians, Customer customer,
                 CarPlace carPlace, OrderStatus status, Integer cost, LocalDate createdDate,
                 LocalDate startDate, LocalDate loadingDate, LocalDate endDate) {
    ...
    public Order(ServiceAdvisor serviceAdvisor, List<Technician> technicians, Customer customer,
                 CarPlace carPlace, LocalDate createdDate, LocalDate startDate, LocalDate loadingDate,
                 LocalDate endDate) {
        this.serviceAdvisor = serviceAdvisor;
        this.technicians = technicians;
        this.customer = customer;
