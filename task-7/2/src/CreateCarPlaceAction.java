...
public class CreateCarPlaceAction extends ConfirmedByConfigurationAction  {
    ...
    public void execute() {
        ...
        var strategyHandlers = new HashMap<String, IPropertyAccessResponseHandler<CarPlace>>();
        strategyHandlers.put("true", new PermissionToAddFreeCarPlaces());
        var responseHandler = strategyHandlers.getOrDefault(config.getProperty("add.remove.free.car.places.permission"),
                new ProhibitionToAddFreeCarPlaces());
