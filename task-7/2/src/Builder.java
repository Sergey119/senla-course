...
public class Builder {
    ...
    public void buildMenu() {
        ...
        mainItems.put(4, new MenuItem("Seed the data", new SeedAction(), null));
    ...
    private Menu buildOrdersMenu() {
        ...
        orderItems.put(11, new MenuItem("Upload orders data from an imported CSV file", new ImportOrdersAction(), null));
        orderItems.put(12, new MenuItem("Download orders data to an exportable CSV file", new ExportOrdersAction(), null));
    ...
    private Menu buildTechniciansMenu() {
        ...
        technicianItems.put(5, new MenuItem("Upload technicians data from an imported CSV file", new ImportTechniciansAction(), null));
        technicianItems.put(6, new MenuItem("Download technicians data to an exportable CSV file", new ExportTechniciansAction(), null));
    ...
    private Menu buildCarPlacesMenu() {
        ...
        spotItems.put(5, new MenuItem("Upload car places data from an imported CSV file", new ImportCarPlacesAction(), null));
        spotItems.put(6, new MenuItem("Download car places data to an exportable CSV file", new ExportCarPlacesAction(), null));
